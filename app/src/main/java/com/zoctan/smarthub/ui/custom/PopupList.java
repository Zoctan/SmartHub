 ...
 * 为View、ListView/GridView绑定长按弹出横向气泡菜单
 */
public class PopupList {
    ...
    public PopupList(final Context context) {
     ...
     */
    public void bind(final View anchorView, final List<String> popupItemList, final PopupListListener popupListListener) {
     ...
     * @param popupListListener the Listener
     */
    public void showPopupListWindow(final View anchorView, final int contextPosition, final float rawX, final float rawY, final List<String> popupItemList, final PopupListListener popupListListener) {
        this.mAnchorView = anchorView;
        this.mPopupItemList = popupItemList;
        this.mPopupListListener = popupListListener;
        this.mPopupWindow = null;
    ...
    private void showPopupListWindow() {
        ...
        if (mPopupWindow == null || mPopupListListener instanceof AdapterPopupListListener) {
            ...
            if (mIndicatorView != null) {
                ...
                final ViewParent viewParent = mIndicatorView.getParent();
            ...
            for (int i = 0; i < mPopupItemList.size(); i++) {
                ...
                if (mPopupListListener instanceof AdapterPopupListListener) {
                    final AdapterPopupListListener adapterPopupListListener = (AdapterPopupListListener) mPopupListListener;
                ...
                if (mPopupItemList.size() > 1 && i != mPopupItemList.size() - 1) {
                    ...
                    final LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(mDividerWidth, mDividerHeight);
                    layoutParams.gravity = Gravity.CENTER;
        ...
        if (mIndicatorView != null) {
            final float marginLeftScreenEdge = mRawX;
            final float marginRightScreenEdge = mScreenWidth - mRawX;
    ...
    private void refreshBackgroundOrRadiusStateList() {
        // left
        final GradientDrawable leftItemPressedDrawable = new GradientDrawable();
        ...
        leftItemPressedDrawable.setCornerRadii(new float[]{
                ...
                0, 0,
                mBackgroundCornerRadius, mBackgroundCornerRadius});
        final GradientDrawable leftItemNormalDrawable = new GradientDrawable();
        ...
        // right
        final GradientDrawable rightItemPressedDrawable = new GradientDrawable();
        ...
        rightItemPressedDrawable.setCornerRadii(new float[]{
                ...
                mBackgroundCornerRadius, mBackgroundCornerRadius,
                0, 0});
        final GradientDrawable rightItemNormalDrawable = new GradientDrawable();
        ...
        // corner
        final GradientDrawable cornerItemPressedDrawable = new GradientDrawable();
        ...
        final GradientDrawable cornerItemNormalDrawable = new GradientDrawable();
    ...
    private StateListDrawable getCenterItemBackground() {
        final StateListDrawable centerItemBackground = new StateListDrawable();
        final GradientDrawable centerItemPressedDrawable = new GradientDrawable();
        centerItemPressedDrawable.setColor(mPressedBackgroundColor);
        final GradientDrawable centerItemNormalDrawable = new GradientDrawable();
    ...
    private void refreshTextColorStateList(final int pressedTextColor, final int normalTextColor) {
        final int[][] states = new int[2][];
        states[0] = new int[]{android.R.attr.state_pressed};
        states[1] = new int[]{};
        final int[] colors = new int[]{pressedTextColor, normalTextColor};
    ...
    public View getDefaultIndicatorView(final Context context) {
        return getTriangleIndicatorView(context, dp2px(16), dp2px(8), DEFAULT_NORMAL_BACKGROUND_COLOR);
    }

    public View getTriangleIndicatorView(final Context context, final float widthPixel, final float heightPixel,
                                         final int color) {
    ...
    public void setIndicatorSize(final int widthPixel, final int heightPixel) {
        this.mIndicatorWidth = widthPixel;
        this.mIndicatorHeight = heightPixel;
        final LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(mIndicatorWidth, mIndicatorHeight);
        layoutParams.gravity = Gravity.CENTER;
        if (mIndicatorView != null) {
            mIndicatorView.setLayoutParams(layoutParams);
        }
    ...
    public void setNormalTextColor(final int normalTextColor) {
    ...
    public void setPressedTextColor(final int pressedTextColor) {
    ...
    public void setTextSize(final float textSizePixel) {
    ...
    public void setTextPaddingLeft(final int textPaddingLeft) {
    ...
    public void setTextPaddingTop(final int textPaddingTop) {
    ...
    public void setTextPaddingRight(final int textPaddingRight) {
    ...
    public void setTextPaddingBottom(final int textPaddingBottom) {
     ...
     */
    public void setTextPadding(final int left, final int top, final int right, final int bottom) {
    ...
    public void setNormalBackgroundColor(final int normalBackgroundColor) {
    ...
    public void setPressedBackgroundColor(final int pressedBackgroundColor) {
    ...
    public void setBackgroundCornerRadius(final int backgroundCornerRadiusPixel) {
    ...
    public void setDividerWidth(final int dividerWidthPixel) {
    ...
    public void setDividerHeight(final int dividerHeightPixel) {
    ...
    public int dp2px(final float value) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                value, getResources().getDisplayMetrics());
    }

    public int sp2px(final float value) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                value, getResources().getDisplayMetrics());
    }

    public abstract static class PopupListListener {
        /**
         ...
         */
        public boolean showPopupList(final View adapterView, final View contextView, final int contextPosition) {
            return true;
        }
         ...
         */
        public abstract void onPopupListClick(View contextView, int contextPosition, int position);
    }

    public abstract static class AdapterPopupListListener extends PopupListListener {
        public abstract String formatText(View adapterView, View contextView, int contextPosition, int position, String text);
    }
}
