...
public class MyViewfinderView extends ViewfinderView {
    ...
    public MyViewfinderView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onDraw(final Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            if (currentLast != null) {
                ...
                paint.setColor(resultPointColor);
                final float radius = POINT_SIZE / 2.0f;
        ...
        postInvalidateDelayed(CUSTOM_ANIMATION_DELAY, frame.left, frame.top, frame.right, frame.bottom);
    }
}